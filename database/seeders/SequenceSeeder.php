...
class SequenceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $journals = [
            ...
            ['name' => 'FACTURA DE VENTA',              'type' => 'sale',           'code' => 'F002', 'document_type_code' => '01'],
            ['name' => 'BOLETA DE VENTA',               'type' => 'sale',           'code' => 'B002', 'document_type_code' => '03'],
            ['name' => 'Cotizaciones',              'type' => 'quote',          'code' => 'COT',  'document_type_code' => null],
            ['name' => 'Nota de Crédito Factura',   'type' => 'sale',           'code' => 'FC01', 'document_type_code' => '07'],
            ['name' => 'Nota de Crédito Boleta',    'type' => 'sale',           'code' => 'BC01', 'document_type_code' => '07'],
            ['name' => 'Nota de Débito Factura',    'type' => 'sale',           'code' => 'FD01', 'document_type_code' => '08'],
            ['name' => 'Nota de Débito Boleta',     'type' => 'sale',           'code' => 'BD01', 'document_type_code' => '08'],
