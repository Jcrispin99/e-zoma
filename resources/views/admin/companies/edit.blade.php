        ...
        <form action="{{ route('admin.companies.update', $company) }}" method="POST" class="space-y-8" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                    ...
                    <x-wire-select 
                        ...
                        :value="old('parent_id', $company->parent_id)"
                        clearable
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                    <x-wire-select 
                        ...
                        :value="old('identity_id', $company->identity_id)"
                        required
                    />
            ...
            <div>
                ...
                <div class="mt-4 flex items-center gap-6">
                    <img src="{{ $company->logo }}" alt="Logo actual" class="h-16 w-16 object-contain rounded border border-gray-200 dark:border-gray-700"/>
                    <div class="flex-1">
                        <label for="logo" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Reemplazar logo (PNG, JPG, WEBP) máx. 2MB</label>
