                ...
                <a href="/" class="flex ms-2 md:me-24">
                    <div class="flex items-center justify-center" aria-label="Logo del sistema ola" role="img">
                        ...
                        <svg class="group cursor-pointer select-none h-12 md:h-14 me-0" viewBox="0 0 210 150"
                            ...
                            <rect x="92" y="20" width="36" height="90" rx="19" fill="#0A3D5C" />
                            <text x="132" y="108" text-anchor="start" font-size="120" font-family="'Nunito', sans-serif"
                                font-weight="900" letter-spacing="-0.02em" fill="#0A3D5C">a</text>
                        </svg>
                    </div>
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Ikoo
                        Dev</span>
                </a>
            </div>
