<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <div>
            @livewire('admin.loyalty.loyalty-rule-list', ['program' => $program], key('rule-list-' . $program->id))
        </div>
        <div>
            @livewire('admin.loyalty.loyalty-reward-list', ['program' => $program], key('reward-list-' . $program->id))
        </div>
    </div>

    <!-- Tablas integradas: modales removidos -->
</div>