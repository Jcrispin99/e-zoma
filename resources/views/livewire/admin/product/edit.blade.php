        ...
        <x-wire-card>
            <div class="space-y-6">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mb-4">Defina los atributos del producto y sus valores. Puede buscar valores existentes o crear nuevos escribiendo en el campo de selección. <strong>Las variantes existentes se mantendrán</strong> y solo se agregarán nuevas variantes si es necesario.</p>
                </div>
                ...
                @if($showVariants && !empty($generatedVariants))
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 {{ isset($variant['id']) ? 'bg-blue-50 border-blue-200' : 'bg-green-50 border-green-200' }} rounded-lg border">
                            <div class="flex-1">
                ...
                @if ($showVariants && count($generatedVariants) > 0)
                    <div class="mt-6">
                        <h4 class="text-md font-medium text-gray-900 mb-3">
                            @if (collect($generatedVariants)->contains('id'))
                                Variantes Existentes ({{ count($generatedVariants) }})
                            @else
                                Variantes Generadas ({{ count($generatedVariants) }})
                            @endif
                        </h4>
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="mt-3 text-sm text-gray-600">
                                <strong>Nota:</strong> Las variantes <span class="text-blue-600 font-medium">existentes</span> se mantendrán y actualizarán con los nuevos precios/SKUs. Las variantes <span class="text-green-600 font-medium">nuevas</span> se crearán al guardar los cambios.
                            </div>
                        </div>
                    </div>
                @endif
